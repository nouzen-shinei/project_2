...
import { initFirebase, runTenantUsageRollup, shutdownFirebase } from '../backend-runtime/src/jobs/tenantUsageRollup';
...
async function markCompleted(
  ...
  await docRef.update({
    ...
    lastMessage: extra.message ?? 'Usage rollup queued successfully.',
    lastError: admin.firestore.FieldValue.delete(),
    ...extra,
  });
}
...
async function main(): Promise<void> {
  ...
  const snapshot = await db
    .collection('tenantUsageRefreshRequests')
